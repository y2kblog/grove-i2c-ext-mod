...
## 販売  
[スイッチサイエンス委託販売ページ](https://www.switch-science.com/products/7251/)  
...
- 通信に失敗する  
伝送路の浮遊容量が大きい場合、I2C信号の立ち上がり時間が長くなり通信に失敗する可能性があります。Grove用I2C通信距離延長モジュールのR5、R6に比較的小さい値の抵抗（例：470Ω）をはんだ付けしてください。  
  <img src="/images/added_R5_R6.jpg" width="350px">  
